...
NAME("RDB$CLIENT_VERSION", nam_client_ver)
...
NAME("RDB$CONTEXT_TYPE", nam_ctx_type)
...
NAME("RDB$HOST_NAME", nam_host_name)
...
NAME("RDB$INITIAL_VALUE", nam_init_val)
...
NAME("RDB$SYSTEM_NULLFLAG", nam_sys_nullflag)
...
NAME("RDB$CRYPT_STATE", nam_crypt_state)
...
NAME("RDB$REMOTE_VERSION", nam_remote_ver)
...
NAME("RDB$VALID_BODY_FLAG", nam_valid_body_flag)
NAME("RDB$PRIVATE_FLAG", nam_private_flag)
NAME("RDB$FUNCTION_BLR", nam_fun_blr)
NAME("RDB$FUNCTION_SOURCE", nam_fun_source)
NAME("RDB$FUNCTION_ID", nam_fun_id)
NAME("RDB$LEGACY_FLAG", nam_legacy_flag)
NAME("RDB$DETERMINISTIC_FLAG", nam_deterministic_flag)
...
NAME("MON$SEC_DATABASE", nam_mon_secdb)
...
NAME("MON$RECORD_RPT_READS", nam_mon_rec_rpt_reads)
NAME("MON$RECORD_SEQ_READS", nam_mon_rec_seq_reads)
NAME("MON$RECORD_STAT_ID", nam_mon_rec_stat_id)
...
NAME("MON$RECORD_IMGC", nam_mon_rec_imgc)
...
NAME("MON$REMOTE_VERSION", nam_mon_remote_ver)
...
NAME("MON$TABLE_NAME", nam_mon_tab_name)
NAME("MON$TABLE_STATS", nam_mon_tab_stats)
...
NAME("RDB$SCHEMA_NAME", nam_sch_name)
NAME("RDB$CHARACTER_SET_SCHEMA_NAME", nam_charset_sch_name)
NAME("RDB$DEFAULT_COLLATE_SCHEMA_NAME", nam_def_coll_sch_name)
NAME("RDB$BASE_COLLATION_SCHEMA_NAME", nam_base_collation_sch_name)
NAME("RDB$RELATION_SCHEMA_NAME", nam_rel_sch_name)
NAME("RDB$DEPENDENT_SCHEMA_NAME", nam_dpd_sch_name)
NAME("RDB$DEPENDED_ON_SCHEMA_NAME", nam_dpd_o_sch_name)
NAME("MON$SCHEMA_NAME", nam_mon_sch_name)
NAME("RDB$SCHEMAS", nam_schemas)
NAME("RDB$FOREIGN_KEY_SCHEMA_NAME", nam_foreign_sch_name)
NAME("RDB$FIELD_SOURCE_SCHEMA_NAME", nam_field_source_sch_name)
NAME("RDB$USER_SCHEMA_NAME", nam_user_sch_name)
NAME("RDB$TABLE_SCHEMA_NAME", nam_tab_sch_name)
