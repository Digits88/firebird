...
// FIXME: field names in comments
// FIXME: ODS version of modified indexes
static const struct ini_idx_t indices[] =
{
	// define index RDB$INDEX_0 for RDB$RELATIONS unique RDB$RELATION_NAME;
	INDEX(0, rel_relations, idx_unique, 2, ODS_13_0)
	...
	INDEX(2, rel_fields, idx_unique, 2, ODS_13_0)
	...
	INDEX(5, rel_indices, idx_unique, 2, ODS_13_0)
	...
	INDEX(6, rel_segments, 0, 2, ODS_13_0)
	...
	INDEX(8, rel_triggers, idx_unique, 2, ODS_13_0)
	...
	INDEX(9, rel_funs, idx_unique, 3, ODS_13_0)
	...
	INDEX(10, rel_args, 0, 3, ODS_13_0)
	...
	INDEX(11, rel_gens, idx_unique, 2, ODS_13_0)
	...
	INDEX(12, rel_rcon, idx_unique, 2, ODS_13_0)
	...
	INDEX(13, rel_refc, idx_unique, 2, ODS_13_0)
	...
	INDEX(14, rel_ccon, 0, 2, ODS_13_0)
	...
	INDEX(15, rel_rfr, idx_unique, 3, ODS_13_0)
		SEGMENT(f_rfr_schema, idx_metadata),	// schema name
	...
	INDEX(18, rel_prc_prms, idx_unique, 4, ODS_13_0)
	...
	INDEX(19, rel_charsets, idx_unique, 2, ODS_13_0)
	...
	INDEX(20, rel_collations, idx_unique, 2, ODS_13_0)
	...
	INDEX(21, rel_procedures, idx_unique, 3, ODS_13_0)
	...
	INDEX(23, rel_exceptions, idx_unique, 2, ODS_13_0)
	...
	INDEX(31, rel_indices, 0, 2, ODS_13_0)
		SEGMENT(f_idx_schema, idx_metadata),	// schema name
	...
	INDEX(33, rel_vrel, 0, 2, ODS_13_0)
	...
	INDEX(34, rel_vrel, 0, 2, ODS_13_0)
	...
	INDEX(35, rel_msgs, 0, 2, ODS_13_0)
	...
	INDEX(36, rel_dims, 0, 2, ODS_13_0)
	...
	INDEX(38, rel_triggers, 0, 2, ODS_13_0)
		SEGMENT(f_trg_schema, idx_metadata),	// schema name
	...
	INDEX(41, rel_indices, 0, 2, ODS_13_0)
		SEGMENT(f_idx_foreign_schema, idx_metadata),	// schema name
	...
	INDEX(42, rel_rcon, 0, 3, ODS_13_0)
		SEGMENT(f_rcon_schema, idx_metadata),	// schema name
	...
	INDEX(43, rel_rcon, 0, 2, ODS_13_0)
		SEGMENT(f_rcon_schema, idx_metadata),	// schema name
	...
	INDEX(45, rel_filters, idx_unique, 1, ODS_13_0)
	...
	INDEX(47, rel_packages, idx_unique, 2, ODS_13_0)
	...
	INDEX(48, rel_prc_prms, 0, 2, ODS_13_0)
	...
	INDEX(49, rel_args, 0, 2, ODS_13_0)
	...
	INDEX(50, rel_prc_prms, 0, 3, ODS_13_0)
	...
	INDEX(51, rel_args, 0, 3, ODS_13_0)
	...
	INDEX(56, rel_pub_tables, idx_unique, 3, ODS_13_0)
		SEGMENT(f_pubtab_tab_schema, idx_metadata),		// schema name
		SEGMENT(f_pubtab_tab_name, idx_string),		// table name	// FIXME: idx_string or idx_metadata?
